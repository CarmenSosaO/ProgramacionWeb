...
<body class="fondo4">
    ...
    <div class="container w-75 bg-dark mt-5 rounded shadow">
        <div class="row">
            <h1 style="color: white;" class="fw-bold text-center pt-3 mb-3">INGRESAR DATOS</h1>
            <form action="mandarRegistro.php" method="post" class="row g-4 mt-4">
                ...
                <div class="col-6">
                    <label style="color: white;"  for="apellido" class="form-label">Apellido</label>
                    <input type="text" name="apellido" class="form-control" placeholder="Escribe tu apellido">
                </div>
                <div class="col-6">
                ...
                <div class="column">
                    <button type="submit" class="btn btn-primary" style="background-color: #3e7312">REGISTRAR</button>
                </div>
                <div class="column">
