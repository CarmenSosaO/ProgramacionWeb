...
?>
    ...
    <div class="container w-75 bg-dark mt-5 rounded shadow">
        ...
        <form class="row g-4 mt-4" method="POST" action="mandarActualizacion.php">
            ...
            <div class="col-6">
                <label style="color: white;"  for="nombre_usuario" class="form-label">Apellido</label>
                <input type="text" name="nombre_usuario" class="form-control" value="<?=$apellido?>" placeholder="Ingresa tu Apellido"/>
            </div>
            <div class="col-6">
